...
export const MENU_EXPLANATIONS: FeatureGuideItem[] = [
  ...
  },
  {
    ...
    icon: "🏠",
    route: "/",
    simpleExplanation: "Halaman beranda utama untuk melihat gambaran utuh kehidupan: identitas diri, visi jangka panjang, babak kehidupan saat ini, nilai inti, dan prinsip hidup.",
    whatYouCanDo: [
      "Melihat ringkasan identitas diri, fokus babak, dan target aktif.",
      "Meninjau nilai-nilai inti dan prinsip hidup sebagai kompas harian.",
      "Memantau kekuatan diri, area pengembangan, dan peran penting.",
      "Menulis 'Jurnal Refleksi': evaluasi berkala keselarasan langkah hidup.",
    ],
    stepByStep: [
      "Buka 'Beranda' (/).",
